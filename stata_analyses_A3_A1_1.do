...
*log using "Analyses with stata\Appendix2_A3_A1_1.log", replace
set seed 50159

*****
capture : file close myfile
file open myfile using "Analyses with stata\Results_for_A3_A1_1_03052020.txt", write replace

	file write myfile "Today is  $S_DATE " 

	file write myfile "Results for A3 in the subgroup randomized for active  ATE: " _n
...
* S E L E C T I O N OF ACTIVE    G R O U P 
keep if a1==1
